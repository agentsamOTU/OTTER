...
int main() {
	...
	while (!glfwWindowShouldClose(window)) {
		...
		transform3 = glm::translate(glm::mat4(1.0f), glm::vec3(-4.0f, glm::sin(static_cast<float>(thisFrame)),1.0f));
		transform3 = transform3 + glm::rotate(glm::mat4(1.0f), static_cast<float>(thisFrame), glm::vec3(1, 0, 0));
