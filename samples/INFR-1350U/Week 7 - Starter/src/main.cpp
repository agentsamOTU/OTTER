...
int main() {
	...
	Texture2DData::sptr diffuse2Map = Texture2DData::LoadFromFile("images/cryingJordan.png");
	...
	while (!glfwWindowShouldClose(window)) {
		...
		for(int ix = 0; ix < 4; ix++) {
			...
			shader->SetUniform("s_DiffuseMix", materials[ix].AlbedoMix);
